...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin-lte/bootstrap/dist/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('admin-lte/font-awesome/css/font-awesome.min.css') }}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('admin-lte/Ionicons/dist/css/ionicons.min.css') }}">
  <!-- Theme style -->
...
<!-- jQuery 3 -->
<script src="{{ asset('admin-lte/jquery/dist/jquery.min.js') }}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('admin-lte/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- AdminLTE App -->
