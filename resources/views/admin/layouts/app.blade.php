...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('ttdyy-admin/Ionicons/dist/css/ionicons.min.css') }}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('ttdyy-admin/dist/css/AdminLTE.min.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>ttdyy</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ttdyy</b>-admin</span>
    </a>
